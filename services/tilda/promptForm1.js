module.exports = function generatePromptForm1(data) {
  try {
    ...
    parts.push(`- Запрашиваемая сумма: 350000 руб.`);
...
# 2. Описание целей и задач проекта (400–500 слов)
# 3. Анализ рыночной ниши (400–500 слов)
# 4. Информация о проекте (400–500 слов)
